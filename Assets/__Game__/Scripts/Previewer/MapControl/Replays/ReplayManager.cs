...
public class ReplayManager : MonoBehaviour {
	...
	public static AnimatedAvatar Avatar {
		get; private set;
	}
	public static RenderTexture AvatarRenderTexture {
		get; private set;
	}

	public static Color? PlayerLeftSaberColor {
		get; private set;
	}
	public static Color? PlayerRightSaberColor {
		get; private set;
	}
	...
	public static float ReplayTimeScale {
		get; private set;
	}
	public static bool BatteryEnergy {
		get; private set;
	}
	public static bool OneLife {
		get; private set;
	}
	...
	public static bool NoBombs {
		get; private set;
	}

	public static float ModifierMult {
		get; private set;
	}
