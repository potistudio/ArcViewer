...
public static class MapStats {
	...
	public static int SwingCount {
		get; private set;
	}
	public static float SpsPeak16 {
		get; private set;
	}
	public static float SpsPeak8 {
		get; private set;
	}
	public static float SpsPeak4 {
		get; private set;
	}

	public static float NpsPeak16 {
		get; private set;
	}
	public static float NpsPeak8 {
		get; private set;
	}
	public static float NpsPeak4 {
		get; private set;
	}
